...
constexpr UINT WM_QUATTRO_TEST_LINK_VISUAL_STATE = WM_APP + 0x75;
constexpr UINT WM_QUATTRO_TEST_MAIN_MENU = WM_APP + 0x76;
...
private:
    ...
    GlobalHotKeyService modifierGestureHotKey_;
    ...
    DoubleModifierGestureKind modifierGestureKind_ = DoubleModifierGestureKind::None;
    UINT_PTR modifierGestureToken_ = 0;
    HWND modifierGestureForeground_ = nullptr;
    ULONGLONG modifierGestureDueTick_ = 0;
