...
function Capture-Case {
    ...
    try {
        ...
        [NativeDisplaySettingsUi]::SetWindowPos($main, [IntPtr]::new(1), 90, 90, 0, 0, 0x0011) | Out-Null
        Set-QuattroTestWindowBackground -Process $process -Window $main -Context "display settings $Name"
